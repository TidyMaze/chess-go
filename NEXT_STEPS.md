...
- [~] Roadmap item 2, the clock: champion on 1s/move against the same champion at fixed depth 6, 300 games. Worth asking now because the root window fix took one second from about 6 plies to 9.4.
